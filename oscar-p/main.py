...
from run_manager import move_input_files_to_input_bucket, move_input_files_to_dead_start_bucket, \
    wait_services_completion, move_bucket_to_dead_start_bucket, download_bucket
...
def final_processing():
    ...
    process_subfolder(results_dir, "full", simple_services)
    ...
    if get_use_ml_library():
        ...
        plot_ml_predictions_graphs(results_dir, simple_services)
